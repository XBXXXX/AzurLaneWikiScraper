...
class MyMainWindow(QtWidgets.QMainWindow, Ui_mainWindow):
    def __init__(self) -> None:
        ...
        self.welcomeMessage = '''
******************************************************************************************
     Welcome! It is a tool to get all of those azurlane pictures from biligame wiki. 
     If you have used the tool before, please keep the same path to avoid repetition. 
     Author: Kumamoto Yoshiyume
     Email: xbissuperman@outlook.com                           
******************************************************************************************
'''
